...
Scaffold only. The first runnable milestone (Postgres via Docker Compose, Flyway migrations, market orders over REST) is in progress. See the roadmap below.
...
| --- | --- |
| Language | Java 21 |
| Framework | Spring Boot 3, Spring Data JPA, Spring WebSocket (STOMP) |
...
Not yet. This section will hold the one-command Docker Compose instructions once the first milestone lands.
